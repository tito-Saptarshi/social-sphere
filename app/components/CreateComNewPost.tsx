...
import { createCommunityPost, createPost } from "@/app/actions";
...
export function CreateComNewPost({ userId, userName, communityId }: Props) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    await createCommunityPost(formData, communityId);
  };
